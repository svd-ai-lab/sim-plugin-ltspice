...
class TestDetectInstalled:
    def test_maps_sim_ltspice_install_to_solver(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sim_plugin_ltspice.driver.find_ltspice", lambda: [fake]
        )
...
class TestRunFile:
    ...
    def test_folds_sim_ltspice_result_into_json_summary(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sim_plugin_ltspice.driver.run_net", lambda _s: fake_lt
        )
    ...
    def test_asc_dispatches_to_run_asc(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("sim_plugin_ltspice.driver.run_asc", fake_asc)
        monkeypatch.setattr("sim_plugin_ltspice.driver.run_net", fake_net)
    ...
    def test_flatten_error_maps_to_runtime_error(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("sim_plugin_ltspice.driver.run_asc", boom)
